 ...
 * {X-line, Y-line, Prescaler, NODE_G(Analog Gain , Digital Gain), filter level}
 */
#define NODE_0_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(5), PRSC_DIV_SEL_8, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                       \
	}
#define NODE_1_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(6), PRSC_DIV_SEL_8, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                       \
	}
#define NODE_2_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(10), PRSC_DIV_SEL_8, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                      \
	}
...
#define NODE_4_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(3), PRSC_DIV_SEL_8, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                       \
	}
#define NODE_5_PARAMS                                                                                                  \
	{                                                                                                                  \
		X_NONE, Y(4), PRSC_DIV_SEL_8, NODE_GAIN(GAIN_1, GAIN_1), FILTER_LEVEL_16                                       \
	}
