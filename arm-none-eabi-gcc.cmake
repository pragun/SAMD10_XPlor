...
_find_compiler(CMAKE_CXX_LINK_EXECUTABLE arm-none-eabi-ld)
...
set(CMAKE_C_FLAGS                   "${APP_C_FLAGS} -mthumb -x c -Og -ffunction-sections -mlong-calls -g3 -Wall -mcpu=cortex-m0plus -c -std=gnu99 -MD -MP -MF" CACHE INTERNAL "")
...
set(CMAKE_CXX_LINK_EXECUTABLE "${CMAKE_LINKER} -o <TARGET> <LINK_FLAGS> <OBJECTS>")
